...
/**
 * Exercise 18: Get list of all employee IDs sorted in ascending order
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice18 {
...
List<Integer> sortedIds = employees.stream()
                .map(Employee::getId)
                .sorted()
                .toList();
        System.out.println("18. Employee IDs sorted ascending: " + sortedIds);
    }
}
