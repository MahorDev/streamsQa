...
/**
 * Exercise 9: Calculate total salary budget for "HR" department
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice09 {
...
double hrSalaryBudget = employees.stream()
                .filter(e -> "HR".equalsIgnoreCase(e.getDepartment()))
                .mapToDouble(Employee::getSalary)
                .sum();
        System.out.println("9. Total HR salary budget: " + hrSalaryBudget);
    }
}
