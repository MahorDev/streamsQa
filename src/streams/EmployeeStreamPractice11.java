...
/**
 * Exercise 11: Group employees by department into Map<String, List<Employee>>
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice11 {
...
Map<String, List<Employee>> empsByDept = employees.stream()
        ...
        System.out.println("11. Employees grouped by department: " + empsByDept.keySet());
    }
}
