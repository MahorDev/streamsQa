...
/**
 * Exercise 17: Find any single employee belonging to "Finance"
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice17 {
...
Optional<Employee> financeEmp = employees.stream()
                .filter(e -> "Finance".equalsIgnoreCase(e.getDepartment()))
                .findAny();
        System.out.println("17. Any employee from Finance: " + financeEmp.orElse(null));
    }
}
