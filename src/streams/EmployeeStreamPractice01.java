...
/**
 * Exercise 1: Sort employees by salary descending using custom Comparator
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice01 {
...
employees.sort(Comparator.comparingDouble(Employee::getSalary).reversed());
        System.out.println("1. Sorted by salary desc: " + employees.get(0).getName() + " ($" + employees.get(0).getSalary() + ")");
    }
}
