...
/**
 * Exercise 8: Calculate average salary across all employees
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice08 {
...
double avgSalaryAll = employees.stream()
                .mapToDouble(Employee::getSalary)
                .average()
                .orElse(0.0);
        System.out.println("8. Average salary across all employees: " + avgSalaryAll);
    }
}
