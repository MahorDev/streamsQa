...
/**
 * Exercise 12: Map department names to list of employee names (Map<String, List<String>>)
 *
 * Separate practice class for independent execution in IntelliJ IDEA.
 */
public class EmployeeStreamPractice12 {
...
Map<String, List<String>> deptToEmpNames = employees.stream()
                .collect(Collectors.groupingBy(
                        Employee::getDepartment,
                        Collectors.mapping(Employee::getName, Collectors.toList())
                ));
        System.out.println("12. Department to employee names map: " + deptToEmpNames);
    }
}
